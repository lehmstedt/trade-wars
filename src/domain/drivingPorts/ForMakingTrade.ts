...
export class ForMakingTrade {
    ...
    constructor(forApplyingTradeOnCountry: ForApplyingTradeOnCountry, forValidatingTradeResource: ForValidatingTradeResource, forCalculatingPrice: ForCalculatingPrice){
