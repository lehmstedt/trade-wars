...
export function ValidateTrade (buyer: Country, seller: Country, soldResource: Resource, soldQuantity: number, currency: Resource, priceProvider: IPriceProvider){
    ...
    const unitPrice = priceProvider.getPrice(
      buyer,
      seller,
      soldResource,
      currency
